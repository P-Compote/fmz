    ...
    <>
      <div>
        <Img
          ...
          alt="ubikEklektik"
          style={{ width: 250, display: 'block', margin: '3rem auto' }}
        />
      </div>
      <h2>
        <em>
      ...
      <TextBox>
        <div>
          <p>
            ...
            összművészeti fesztiválja. Szervezetünk struktúrája is erre épít, 90
            aktív önkéntesünk (művészek, zenészek, közösségfejlesztők), a
        ...
        <div>
          <p>
            A kreatív alkotóközösségek, mind egy-egy törzset képviselnek, saját
            történettel, szervezeti hálóval és művészeti programmal. A történet
            szerint a közösség az Együttállást kutatja évről évre.
          </p>
        </div>
      </TextBox>
      <h2>
