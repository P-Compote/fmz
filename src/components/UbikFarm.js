    ...
    <>
      ...
      <h2>
        <em>
          ...
          /Ubiciták - Az Orákulum Nagyon Óvatos Eljárásai 12./
        </em>
      </h2>
      <TextBox>
        <div>
          <p>
            Az UbikFarm egy underground művészeti és természetiközeli fesztivál,
            amelyet egy önellátó közösségi gazdaságban szervezünk,
            Vértesszőlősön. Célja, hogy bemutassuk a farm működését és szokásait
            az idelátogatók számára, valamint fellépési lehetőséget teremtsünk a
            feltörekvő fiatal művészek és ritka underground műfajok
            képviselőinek.
          </p>
        </div>
        <div>
